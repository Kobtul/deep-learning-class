...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", default=50, type=int, help="Batch size.") # means number of vectors computetd in on step
    ...
    accuracy = network.get_accuracy("test", mnist.test.images, mnist.test.labels)
